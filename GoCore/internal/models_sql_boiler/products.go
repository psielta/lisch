...
type Product struct {
	...
	SellerID    string    `boil:"seller_id" json:"seller_id" toml:"seller_id" yaml:"seller_id"`
	ProductName string    `boil:"product_name" json:"product_name" toml:"product_name" yaml:"product_name"`
	Description string    `boil:"description" json:"description" toml:"description" yaml:"description"`
	Baseprice   float64   `boil:"baseprice" json:"baseprice" toml:"baseprice" yaml:"baseprice"`
	AuctionEnd  time.Time `boil:"auction_end" json:"auction_end" toml:"auction_end" yaml:"auction_end"`
	IsSold      bool      `boil:"is_sold" json:"is_sold" toml:"is_sold" yaml:"is_sold"`
...
var ProductTableColumns = struct {
	...
	AuctionEnd:  "products.auction_end",
	IsSold:      "products.is_sold",
...
var ProductWhere = struct {
	...
	Baseprice   whereHelperfloat64
	AuctionEnd  whereHelpertime_Time
	IsSold      whereHelperbool
	CreatedAt   whereHelpertime_Time
	UpdatedAt   whereHelpertime_Time
	TenantID    whereHelperstring
}{
	ID:          whereHelperstring{field: "\"products\".\"id\""},
	SellerID:    whereHelperstring{field: "\"products\".\"seller_id\""},
	ProductName: whereHelperstring{field: "\"products\".\"product_name\""},
	Description: whereHelperstring{field: "\"products\".\"description\""},
	Baseprice:   whereHelperfloat64{field: "\"products\".\"baseprice\""},
	AuctionEnd:  whereHelpertime_Time{field: "\"products\".\"auction_end\""},
	IsSold:      whereHelperbool{field: "\"products\".\"is_sold\""},
	CreatedAt:   whereHelpertime_Time{field: "\"products\".\"created_at\""},
	UpdatedAt:   whereHelpertime_Time{field: "\"products\".\"updated_at\""},
	TenantID:    whereHelperstring{field: "\"products\".\"tenant_id\""},
}
...
func (r *productR) GetTenant() *Tenant {
	if r == nil {
		return nil
	}
	return r.Tenant
...
var (
	productAllColumns            = []string{"id", "seller_id", "product_name", "description", "baseprice", "auction_end", "is_sold", "created_at", "updated_at", "tenant_id"}
	productColumnsWithoutDefault = []string{"seller_id", "product_name", "description", "baseprice", "auction_end", "tenant_id"}
	productColumnsWithDefault    = []string{"id", "is_sold", "created_at", "updated_at"}
...
func (q productQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Product, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models_sql_boiler: failed to execute a one query for products")
	}
...
func (q productQuery) All(ctx context.Context, exec boil.ContextExecutor) (ProductSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models_sql_boiler: failed to assign all query results to Product slice")
	}
...
func (q productQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: failed to count products rows")
	}
...
func (q productQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models_sql_boiler: failed to check if products exists")
	}
...
func (o *Product) Tenant(mods ...qm.QueryMod) tenantQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (productL) LoadTenant(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	var slice []*Product
	var object *Product
...
// SetTenant of the product to the related item.
// Sets o.R.Tenant to related.
// Adds o to related.R.Products.
func (o *Product) SetTenant(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Tenant) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func FindProduct(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Product, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models_sql_boiler: unable to select from products")
	}
...
func (o *Product) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models_sql_boiler: no products provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models_sql_boiler: unable to insert into products")
	}
...
func (o *Product) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models_sql_boiler: unable to update products, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: unable to update products row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: failed to get rows affected by update for products")
	}
...
func (q productQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: unable to update all for products")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: unable to retrieve rows affected for products")
	}
...
func (o ProductSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: unable to update all in product slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: unable to retrieve rows affected all in update all product")
	}
	return rowsAff, nil
}
...
func (o *Product) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("models_sql_boiler: no products provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models_sql_boiler: unable to upsert products, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(productPrimaryKeyColumns) == 0 {
				return errors.New("models_sql_boiler: unable to upsert products, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "models_sql_boiler: unable to upsert products")
	}
...
func (o *Product) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models_sql_boiler: no Product provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: unable to delete from products")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: failed to get rows affected by delete for products")
	}
...
func (q productQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models_sql_boiler: no productQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: unable to delete all from products")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: failed to get rows affected by deleteall for products")
	}
...
func (o ProductSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models_sql_boiler: unable to delete all from product slice")
	}
...
func (o *ProductSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models_sql_boiler: unable to reload all in ProductSlice")
	}
...
func ProductExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models_sql_boiler: unable to check if products exists")
	}
